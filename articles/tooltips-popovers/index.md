...
This article on
[`tooltip()`](https://rstudio.github.io/bslib/reference/tooltip.md) and
...
[`popover()`](https://rstudio.github.io/bslib/reference/popover.md), a
`title` may also be provided.
...
[`tooltip()`](https://rstudio.github.io/bslib/reference/tooltip.md) (or
[`popover()`](https://rstudio.github.io/bslib/reference/popover.md)).
...
[`tooltip()`](https://rstudio.github.io/bslib/reference/tooltip.md) and
[`popover()`](https://rstudio.github.io/bslib/reference/popover.md) use
...
[Cards](https://rstudio.github.io/bslib/articles/tooltips-popovers/cards.md)
...
inside a
[`card_header()`](https://rstudio.github.io/bslib/reference/card_body.md)/[`card_footer()`](https://rstudio.github.io/bslib/reference/card_body.md)
...
this case, a
[`tooltip()`](https://rstudio.github.io/bslib/reference/tooltip.md) can
...
[`popover()`](https://rstudio.github.io/bslib/reference/popover.md)s are
not only useful for creating [input toolbars](#input-toolbar), but can
also be useful in non-input situations, like providing more context
...
Use
[`toggle_tooltip()`](https://rstudio.github.io/bslib/reference/tooltip.md)/[`toggle_popover()`](https://rstudio.github.io/bslib/reference/popover.md)
to programmatically show/hide a
[`tooltip()`](https://rstudio.github.io/bslib/reference/tooltip.md)/[`popover()`](https://rstudio.github.io/bslib/reference/popover.md).
...
Use
[`update_tooltip()`](https://rstudio.github.io/bslib/reference/tooltip.md)/[`update_popover()`](https://rstudio.github.io/bslib/reference/popover.md)
...
Both [`tooltip()`](https://rstudio.github.io/bslib/reference/tooltip.md)
and [`popover()`](https://rstudio.github.io/bslib/reference/popover.md)
...
might wonder when a
[`popover()`](https://rstudio.github.io/bslib/reference/popover.md) is
...
In contrast,
[`popover()`](https://rstudio.github.io/bslib/reference/popover.md)s are
more appropriate for “non-blocking” interactions (i.e., the user can
...
[`popover()`](https://rstudio.github.io/bslib/reference/popover.md). For
this reason,
[`popover()`](https://rstudio.github.io/bslib/reference/popover.md)
changes the trigger interaction to hover/focus when attached to a
hyperlink (i.e., it acts more like a
[`tooltip()`](https://rstudio.github.io/bslib/reference/tooltip.md) in
this case), which at least makes the popover content visible. That said,
this is still a bit of a confusing UX, and thus should be avoided.
