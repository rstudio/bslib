...
[card](https://rstudio.github.io/bslib/articles/cards). For example,
when used inside
[`page_fillable()`](https://rstudio.github.io/bslib/reference/page_fillable.md)
...
[`card()`](https://rstudio.github.io/bslib/reference/card.md) (which is
useful for adding a header/footer, `full_screen = TRUE`, etc.).
...
article on [filling
layouts](https://rstudio.github.io/bslib/articles/filling).

### Multi-page varied layout

As we covered in [Getting Started with
dashboards](https://rstudio.github.io/bslib/articles/dashboards), the
`sidebar` argument of
[`page_navbar()`](https://rstudio.github.io/bslib/reference/page_navbar.md)
...
Just like with
[cards](https://rstudio.github.io/bslib/articles/cards#restricting-growth),
...
[`card()`](https://rstudio.github.io/bslib/reference/card.md) (as well
as `full_screen = TRUE` to reduce the need for scrolling).
...
[`page_navbar()`](https://rstudio.github.io/bslib/reference/page_navbar.md)
(or in
[`navset_card_tab()`](https://rstudio.github.io/bslib/reference/navset.md)/`navset_tab_pill()`).
...
[`sidebar()`](https://rstudio.github.io/bslib/reference/sidebar.md) (as
an immediate child of the sidebar), the accordion panels will render
...
[`sidebar()`](https://rstudio.github.io/bslib/reference/sidebar.md) and
[`layout_sidebar()`](https://rstudio.github.io/bslib/reference/sidebar.md)
...
Both [`sidebar()`](https://rstudio.github.io/bslib/reference/sidebar.md)
and
[`layout_sidebar()`](https://rstudio.github.io/bslib/reference/sidebar.md)
...
([theming via
`bs_theme()`](https://rstudio.github.io/bslib/articles/bs5-variables)
