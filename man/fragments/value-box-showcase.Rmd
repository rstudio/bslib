...
Set `showcase` to the name of the layout you'd like, or use the `showcase_left_center()`, `showcase_top_right()`, or `showcase_bottom()` helper functions to customize the height or width of the showcase area.
...
sparkline_plot <- function() {
  prepped_sparkline <- system.file("man", "figures", "showcase-plot-1.png",  package = "bslib")
  img <- htmltools::tags$img(
    src = paste0("file://", prepped_sparkline),
    alt = paste(
