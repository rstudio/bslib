...
If the feature has not yet been filed, then please describe the feature you'd like to see become a part of bslib. See Shiny's guide on how to write good feature requests:
