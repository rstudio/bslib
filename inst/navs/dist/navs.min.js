(function (global, factory) {
  ...
  class Navs extends _ {
    ...
    render() {
      ...
      return preact.h(d, null, preact.h("ul", {
        id: props.id,
        className: ulClass,
        role: "tablist",
        "data-tabsetid": this.state.tabsetId
      }, this.state.children), preact.h("div", {
    ...
    addChildProps(children, tabsetId, selected) {
      var self = this;
      return A(children).map(function (x, idx) {
        if (x.type.name === 'NavMenu') {
  ...
  class NavsCard extends Navs {
    render() {
      ...
      const ulTag = preact.h("ul", {
        id: props.id,
        className: ulClass,
        role: "tablist",
        "data-tabsetid": this.state.tabsetId
      }, this.state.children);
      const divTag = preact.h("div", {
        className: "tab-content",
        "data-tabsetid": this.state.tabsetId
      }, props.header, this.state.content, props.footer);
      ...
      return preact.h("div", {
        className: "card"
      }, below ? null : preact.h("div", {
        className: "card-header"
      }, " ", ulTag, " "), preact.h("div", {
        className: "card-body"
      }, " ", divTag, " "), below ? preact.h("div", {
