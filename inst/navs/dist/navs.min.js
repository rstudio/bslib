	...
	*/
	...
	class Navs extends react.exports.Component {
	  ...
	  render() {
	    ...
	    return /*#__PURE__*/React.createElement(react.exports.Fragment, null, /*#__PURE__*/React.createElement("ul", {
	      id: props.id,
	      className: ulClass,
	      role: "tablist",
	  ...
	  addChildProps(children, tabsetId, selected) {
	    ...
	    return react.exports.Children.map(children, (x, idx) => {
	      if (x.type.name === 'NavMenu') {
	        ...
	        return react.exports.cloneElement(x, {
	          tabsetId,
	          selected
	        }, children_);
	      }
	...
	class NavsCard extends Navs {
	  render() {
	    ...
	    const ulTag = /*#__PURE__*/React.createElement("ul", {
	      id: props.id,
	      className: ulClass,
	      role: "tablist",
	      "data-tabsetid": this.state.tabsetId
	    }, this.state.children);
	    const divTag = /*#__PURE__*/React.createElement("div", {
	      className: "tab-content",
	      "data-tabsetid": this.state.tabsetId
	    }, props.header, this.state.content, props.footer);
	...
	class NavsBar extends Navs {
	  render() {
	    ...
	    const ulTag = /*#__PURE__*/React.createElement("ul", {
	      id: props.id,
	      className: `nav navbar-nav ${props.id ? 'shiny-tab-input' : ''}`,
	      role: "tablist",
	      "data-tabsetid": this.state.tabsetId
	    }, this.state.children);
	    ...
	    }, containerDiv), /*#__PURE__*/React.createElement("div", {
	      className: "tab-content",
	      "data-tabsetid": this.state.tabsetId
	    }, props.header, this.state.content, props.footer));
	  }
