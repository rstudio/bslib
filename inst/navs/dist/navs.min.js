(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.bslib = {}));
	...
	*/
	...
	class Navs extends react.exports.Component {
	  constructor(props) {
	    super(props);
	    ...
	    const selected = props.selected ? props.selected : this.firstNavValue(props.children); // false means that active classes shouldn't be added, no matter what (nav_insert() uses this)

	    if (props.selected === false) selected = null;
	    const children = this.addChildProps(props.children, {
	      tabsetId,
	      selected
	    });
	  ...
	  render() {
	    ...
	    const {
	      ulTag,
	      divTag
	    } = _buildTabset(props, this.state, ulClass);

	    return /*#__PURE__*/React.createElement(react.exports.Fragment, null, ulTag, divTag);
	  }
	  ...
	  getContent(navs) {
	    const result = [];
	    react.exports.Children.forEach(navs, x => {
	      if (x.type.name === 'NavMenu') {
	  ...
	  addChildProps(children, props) {
	    var self = this;
	    return react.exports.Children.map(children, (x, idx) => {
	      if (typeof x === "string") {
	      ...
	      if (x.type.name === 'NavMenu') {
	        ...
	        return react.exports.cloneElement(x, props, children_);
	      }

	      props.id = `tab-${props.tabsetId}-${idx + 1}`;
	      return react.exports.cloneElement(x, props);
	    });
	  }
	...
	class NavsList extends Navs {
	  render() {
	    ...
	    return /*#__PURE__*/React.createElement("div", {
	      ...
	      className: `col-sm-${widthNav} ${props.well ? 'well' : ''}`
	    }, ulTag), /*#__PURE__*/React.createElement("div", {
	      className: `col-sm-${widthContent}`
	    }, divTag));
	  }
	...
	class NavsBar extends Navs {
	  render() {
	    ...
	    const navbarHeader = /*#__PURE__*/React.createElement("div", {
	      className: "navbar-header"
	    }, props.collapse ? collapseBtn : null, /*#__PURE__*/React.createElement("span", {
	    ...
	    const {
	      ulTag,
	      divTag
	    } = _buildTabset(props, this.state, 'nav navbar-nav');

	    const containerDiv = /*#__PURE__*/React.createElement("div", {
	      className: `container${props.fluid ? '-fluid' : ''}`
	    }, navbarHeader, collapseId ? /*#__PURE__*/React.createElement("div", {
	      className: "collapse navbar-collapse",
	      id: collapseId
	    }, ulTag) : ulTag);
	    const navbarClass = `navbar navbar-default ${props.inverse ? 'navbar-inverse' : ''} ${props.position ? 'navbar-' + props.position : ''}`; // TODO:
	    ...
	    return /*#__PURE__*/React.createElement(react.exports.Fragment, null, /*#__PURE__*/React.createElement("nav", {
	      className: navbarClass,
	      role: "navigation",
	      ref: el => el && props.bg && el.style.setProperty("background-color", props.bg, "important")
	    }, containerDiv), divTag);
	  }
	...
	function NavMenu(props) {
	  const vals = props.children.map(function (x) {
	    return x.props.value;
	  });
	...
	function _buildTabset(props, state, ulClass) {
	  ...
	  return {
	    ulTag: /*#__PURE__*/React.createElement("ul", {
	      id: props.id,
	      className: ulClass,
	      role: "tablist",
	      "data-tabsetid": state.tabsetId
	    }, state.children),
	    divTag: /*#__PURE__*/React.createElement("div", {
	      className: "tab-content",
	      "data-tabsetid": state.tabsetId
	    }, props.header, state.content, props.footer)
	  };
	}
	...
	exports.NavSpacer = NavSpacer;
	exports.Navs = Navs;
	exports.NavsBar = NavsBar;
	exports.NavsCard = NavsCard;
	exports.NavsList = NavsList;
