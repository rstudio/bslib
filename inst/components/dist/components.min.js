...
`+s.value.substring(t),s.selectionStart=s.selectionEnd=e+1,s.dispatchEvent(new Event("input",{bubbles:!0}))}var S,L,le,U,ce=p(()=>{"use strict";E();S="textSubmitInputBinding",L={input:"bslib-input-submit-textarea",container:"bslib-submit-textarea-container",button:"bslib-submit-textarea-btn",submitKey:"bslib-submit-key"},le=new IntersectionObserver(s=>{s.forEach(e=>{e.isIntersecting&&q(e.target)})}),U=class extends m{find(e){return $(e).find(`.${L.input} textarea`)}initialize(e){de(e),q(e),Se(e)}getValue(e){return $(e).data("val")}setValue(e,t){e.value=t}subscribe(e,t){function i(){$(e).data("val",e.value),e.value="",e.dispatchEvent(new Event("input",{bubbles:!0})),t("event")}let n=O(e);n.classList.contains("shiny-bound-input")?$(n).on(`shiny:inputchanged.${S}`,i):$(n).on(`click.${S}`,i),$(e).on(`input.${S}`,function(){de(e),q(e)}),$(e).on(`keydown.${S}`,function(o){if(o.key!=="Enter")return;if(!e.value){o.preventDefault();return}if(o.shiftKey)return;if(o.altKey){o.preventDefault(),Le(e);return}let d=e.hasAttribute("data-needs-modifier");if(!d){o.preventDefault(),n.click();return}let a=o.ctrlKey||o.metaKey;if(d&&a){o.preventDefault(),n.click();return}});let r=e.closest(`.${L.container}`);$(r).on(`click.${S}`,o=>{o.target.classList.contains(L.container)&&e.focus()}),le.observe(e)}unsubscribe(e){$(e).off(`.${S}`);let t=e.nextElementSibling;$(t).off(`.${S}`);let i=e.closest(`.${L.container}`);$(i).off(`.${S}`),le.unobserve(e)}receiveMessage(e,t){return u(this,null,function*(){let i=e.value;if(t.value!==void 0&&(e.value=t.value,e.dispatchEvent(new Event("input",{bubbles:!0}))),t.placeholder!==void 0&&(e.placeholder=t.placeholder),t.label!==void 0){let n=$(e).closest(`.${L.input}`).find("label");yield te(t.label,n)}t.submit&&(O(e).click(),e.value=i),t.focus&&e.focus()})}};v(U,"submit-text-area")});function k(s){if(window.Shiny)for(let[e,t]of Object.entries(s))window.Shiny.addCustomMessageHandler(e,t)}var V=p(()=>{"use strict"});function Me(s){return u(this,null,function*(){let{html:e,deps:t,options:i,position:n,id:r}=s;if(!window.bootstrap||!window.bootstrap.Toast){R({headline:"Bootstrap 5 Required",message:"Toast notifications require Bootstrap 5.",status:"error"});return}let o=Te.getOrCreateContainer(n);yield g(o,{html:e,deps:t},"beforeEnd");let d=document.getElementById(r);if(!d){R({headline:"Toast Creation Failed",message:`Failed to create toast with id "${r}".`,status:"error"});return}let a=new X(d,i);G.set(d,a),a.show(),d.addEventListener("hidden.bs.toast",()=>{var h,M;(M=(h=window==null?void 0:window.Shiny)==null?void 0:h.unbindAll)==null||M.call(h,d),d.remove(),G.delete(d),o.children.length===0&&o.remove()})})}function we(s){let{id:e}=s,t=document.getElementById(e);if(!t){R({headline:"Toast Not Found",message:`No toast with id "${e}" was found.`,status:"warning"});return}let i=G.get(t);i&&i.hide()}var ue,K,Te,X,G,he=p(()=>{"use strict";V();E();ue=window.bootstrap?window.bootstrap.Toast:class{},K=class{constructor(){this.containers=new Map}getOrCreateContainer(e){let t=this.containers.get(e);return(!t||!document.body.contains(t))&&(t=this._createContainer(e),this.containers.set(e,t)),t}_createContainer(e){let t=document.createElement("div");t.className="toast-container position-fixed p-1 p-md-2",t.setAttribute("data-bslib-toast-container",e);let i=this._getPositionClasses(e);return t.classList.add(...i),document.body.appendChild(t),t}_getPositionClasses(e){return{"top-left":["top-0","start-0"],"top-center":["top-0","start-50","translate-middle-x"],"top-right":["top-0","end-0"],"middle-left":["top-50","start-0","translate-middle-y"],"middle-center":["top-50","start-50","translate-middle"],"middle-right":["top-50","end-0","translate-middle-y"],"bottom-left":["bottom-0","start-0"],"bottom-center":["bottom-0","start-50","translate-middle-x"],"bottom-right":["bottom-0","end-0"]}[e]}},Te=new K,X=class{constructor(e,t){this.progressBar=null;this.startTime=0;this.duration=0;this.hideTimeoutId=null;if(this.element=e,t.autohide){let i=t.delay||5e3;this.duration=i,this._addProgressBar(i);let n=J(Z({},t),{autohide:!1});this.bsToast=new ue(e,n),this._setupHoverPause()}else this.bsToast=new ue(e,t)}show(){this.bsToast.show()}hide(){this.hideTimeoutId!==null&&(clearTimeout(this.hideTimeoutId),this.hideTimeoutId=null),this.bsToast.hide()}_addProgressBar(e){this.progressBar=document.createElement("div"),this.progressBar.className="bslib-toast-progress-bar",this.progressBar.style.cssText=`
  ...
  </svg>`,document.body.appendChild(s.children[0])}document.readyState==="complete"?be():document.addEventListener("DOMContentLoaded",be)});_e();})();
