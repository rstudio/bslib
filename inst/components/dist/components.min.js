...
`+s.value.substring(t),s.selectionStart=s.selectionEnd=e+1,s.dispatchEvent(new Event("input",{bubbles:!0}))}var M,w,Te,ee,Me=v(()=>{"use strict";y();M="textSubmitInputBinding",w={input:"bslib-input-submit-textarea",container:"bslib-submit-textarea-container",button:"bslib-submit-textarea-btn",submitKey:"bslib-submit-key"},Te=new IntersectionObserver(s=>{s.forEach(e=>{e.isIntersecting&&te(e.target)})}),ee=class extends f{find(e){return $(e).find(`.${w.input} textarea`)}initialize(e){Se(e),te(e),ke(e)}getValue(e){return $(e).data("val")}setValue(e,t){e.value=t}subscribe(e,t){function i(){$(e).data("val",e.value),e.value="",e.dispatchEvent(new Event("input",{bubbles:!0})),t("event")}let n=K(e);n.classList.contains("shiny-bound-input")?$(n).on(`shiny:inputchanged.${M}`,i):$(n).on(`click.${M}`,i),$(e).on(`input.${M}`,function(){Se(e),te(e)}),$(e).on(`keydown.${M}`,function(o){if(o.key!=="Enter")return;if(!e.value){o.preventDefault();return}if(o.shiftKey)return;if(o.altKey){o.preventDefault(),$e(e);return}let d=e.hasAttribute("data-needs-modifier");if(!d){o.preventDefault(),n.click();return}let a=o.ctrlKey||o.metaKey;if(d&&a){o.preventDefault(),n.click();return}});let r=e.closest(`.${w.container}`);$(r).on(`click.${M}`,o=>{o.target.classList.contains(w.container)&&e.focus()}),Te.observe(e)}unsubscribe(e){$(e).off(`.${M}`);let t=e.nextElementSibling;$(t).off(`.${M}`);let i=e.closest(`.${w.container}`);$(i).off(`.${M}`),Te.unobserve(e)}receiveMessage(e,t){return u(this,null,function*(){let i=e.value;if(t.value!==void 0&&(e.value=t.value,e.dispatchEvent(new Event("input",{bubbles:!0}))),t.placeholder!==void 0&&(e.placeholder=t.placeholder),t.label!==void 0){let n=$(e).closest(`.${w.input}`).find("label");yield de(t.label,n)}t.submit&&(K(e).click(),e.value=i),t.focus&&e.focus()})}};E(ee,"submit-text-area")});function De(s){return u(this,null,function*(){var D,se;let{html:e,deps:t,autohide:i,duration:n,position:r,id:o}=s;if(!window.bootstrap||!window.bootstrap.Toast){P({headline:"Bootstrap 5 Required",message:"Toast notifications require Bootstrap 5.",status:"error"});return}let d=document.getElementById(o);if(d){let H=N.get(d);H&&(H.hide(),N.delete(d)),(se=(D=window==null?void 0:window.Shiny)==null?void 0:D.unbindAll)==null||se.call(D,d),d.remove()}let a=Ne.getOrCreateToaster(r);yield h(a,{html:e,deps:t},"beforeEnd");let p=document.getElementById(o);if(!p){P({headline:"Toast Creation Failed",message:`Failed to create toast with id "${o}".`,status:"error"});return}let C=new ie(p,{autohide:i,duration:n});N.set(p,C),C.show(),p.addEventListener("hidden.bs.toast",()=>{var H,ne;(ne=(H=window==null?void 0:window.Shiny)==null?void 0:H.unbindAll)==null||ne.call(H,p),p.remove(),N.delete(p),a.children.length===0&&a.remove()})})}function Fe(s){let{id:e}=s,t=document.getElementById(e);if(!t){P({headline:"Toast Not Found",message:`No toast with id "${e}" was found.`,status:"warning"});return}let i=N.get(t);i&&i.hide()}var Be,k,Ne,ie,N,we=v(()=>{"use strict";U();y();Be=window.bootstrap?window.bootstrap.Toast:class{},k=class{constructor(){this.containers=new Map}getOrCreateToaster(e){let t=this.containers.get(e);return(!t||!document.body.contains(t))&&(t=k._createToaster(e),document.body.appendChild(t),this.containers.set(e,t)),t}static _createToaster(e){let t=document.createElement("div");return t.className="toast-container position-fixed p-1 p-md-2",t.setAttribute("data-bslib-toast-container",e),t.classList.add(...k._positionClasses(e)),t}static _positionClasses(e){return{"top-left":["top-0","start-0"],"top-center":["top-0","start-50","translate-middle-x"],"top-right":["top-0","end-0"],"middle-left":["top-50","start-0","translate-middle-y"],"middle-center":["top-50","start-50","translate-middle"],"middle-right":["top-50","end-0","translate-middle-y"],"bottom-left":["bottom-0","start-0"],"bottom-center":["bottom-0","start-50","translate-middle-x"],"bottom-right":["bottom-0","end-0"]}[e]}},Ne=new k,ie=class{constructor(e,t){this.progressBar=null;this.timeStart=0;this.timeRemaining=0;this.hideTimeoutId=null;this.isPaused=!1;this.isPointerOver=!1;this.hasFocus=!1;this.element=e,this.timeRemaining=t.duration||5e3;let i={animation:!0,autohide:!1};this.bsToast=new Be(e,i),t.autohide&&(this._addProgressBar(),this._setupInteractionPause())}show(){this.bsToast.show()}hide(){this.hideTimeoutId!==null&&(clearTimeout(this.hideTimeoutId),this.hideTimeoutId=null),this.bsToast.hide()}_addProgressBar(){this.progressBar=document.createElement("div"),this.progressBar.className="bslib-toast-progress-bar",this.progressBar.style.cssText=`
  ...
  </svg>`,document.body.appendChild(s.children[0])}document.readyState==="complete"?He():document.addEventListener("DOMContentLoaded",He)});We();})();
