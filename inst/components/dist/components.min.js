...
`+s.value.substring(t),s.selectionStart=s.selectionEnd=e+1,s.dispatchEvent(new Event("input",{bubbles:!0}))}var M,H,ye,te,Te=v(()=>{"use strict";y();M="textSubmitInputBinding",H={input:"bslib-input-submit-textarea",container:"bslib-submit-textarea-container",button:"bslib-submit-textarea-btn",submitKey:"bslib-submit-key"},ye=new IntersectionObserver(s=>{s.forEach(e=>{e.isIntersecting&&ie(e.target)})}),te=class extends f{find(e){return $(e).find(`.${H.input} textarea`)}initialize(e){Le(e),ie(e),Ae(e)}getValue(e){return $(e).data("val")}setValue(e,t){e.value=t}subscribe(e,t){function i(){$(e).data("val",e.value),e.value="",e.dispatchEvent(new Event("input",{bubbles:!0})),t("event")}let n=X(e);n.classList.contains("shiny-bound-input")?$(n).on(`shiny:inputchanged.${M}`,i):$(n).on(`click.${M}`,i),$(e).on(`input.${M}`,function(){Le(e),ie(e)}),$(e).on(`keydown.${M}`,function(o){if(o.key!=="Enter")return;if(!e.value){o.preventDefault();return}if(o.shiftKey)return;if(o.altKey){o.preventDefault(),ze(e);return}let c=e.hasAttribute("data-needs-modifier");if(!c){o.preventDefault(),n.click();return}let a=o.ctrlKey||o.metaKey;if(c&&a){o.preventDefault(),n.click();return}});let r=e.closest(`.${H.container}`);$(r).on(`click.${M}`,o=>{o.target.classList.contains(H.container)&&e.focus()}),ye.observe(e)}unsubscribe(e){$(e).off(`.${M}`);let t=e.nextElementSibling;$(t).off(`.${M}`);let i=e.closest(`.${H.container}`);$(i).off(`.${M}`),ye.unobserve(e)}receiveMessage(e,t){return h(this,null,function*(){let i=e.value;if(t.value!==void 0&&(e.value=t.value,e.dispatchEvent(new Event("input",{bubbles:!0}))),t.placeholder!==void 0&&(e.placeholder=t.placeholder),t.label!==void 0){let n=$(e).closest(`.${H.input}`).find("label");yield le(t.label,n)}t.submit&&(X(e).click(),e.value=i),t.focus&&e.focus()})}};E(te,"submit-text-area")});function xe(s){return h(this,null,function*(){var B,ne;let{html:e,deps:t,autohide:i,duration:n,position:r,id:o}=s;if(!window.bootstrap||!window.bootstrap.Toast){F({headline:"Bootstrap 5 Required",message:"Toast notifications require Bootstrap 5.",status:"error"});return}let c=document.getElementById(o);if(c){let w=D.get(c);w&&(w.hide(),D.delete(c)),(ne=(B=window==null?void 0:window.Shiny)==null?void 0:B.unbindAll)==null||ne.call(B,c),c.remove()}let a=Re.getOrCreateToaster(r);yield b(a,{html:e,deps:t},"beforeEnd");let p=document.getElementById(o);if(!p){F({headline:"Toast Creation Failed",message:`Failed to create toast with id "${o}".`,status:"error"});return}let C=new se(p,{autohide:i,duration:n});D.set(p,C),C.show(),p.addEventListener("hidden.bs.toast",()=>{var w,re;(re=(w=window==null?void 0:window.Shiny)==null?void 0:w.unbindAll)==null||re.call(w,p),p.remove(),D.delete(p),a.children.length===0&&a.remove()})})}function Oe(s){let{id:e}=s,t=document.getElementById(e);if(!t){F({headline:"Toast Not Found",message:`No toast with id "${e}" was found.`,status:"warning"});return}let i=D.get(t);i&&i.hide()}var Ie,k,Re,se,D,Se=v(()=>{"use strict";V();y();Ie=window.bootstrap?window.bootstrap.Toast:class{},k=class{constructor(){this.containers=new Map}getOrCreateToaster(e){let t=this.containers.get(e);return(!t||!document.body.contains(t))&&(t=k._createToaster(e),document.body.appendChild(t),this.containers.set(e,t)),t}static _createToaster(e){let t=document.createElement("div");return t.className="toast-container position-fixed p-1 p-md-2",t.setAttribute("data-bslib-toast-container",e),t.classList.add(...k._positionClasses(e)),t}static _positionClasses(e){return{"top-left":["top-0","start-0"],"top-center":["top-0","start-50","translate-middle-x"],"top-right":["top-0","end-0"],"middle-left":["top-50","start-0","translate-middle-y"],"middle-center":["top-50","start-50","translate-middle"],"middle-right":["top-50","end-0","translate-middle-y"],"bottom-left":["bottom-0","start-0"],"bottom-center":["bottom-0","start-50","translate-middle-x"],"bottom-right":["bottom-0","end-0"]}[e]}},Re=new k,se=class{constructor(e,t){this.progressBar=null;this.timeStart=0;this.timeRemaining=0;this.hideTimeoutId=null;this.isPaused=!1;this.isPointerOver=!1;this.hasFocus=!1;this.element=e,this.timeRemaining=t.duration||5e3;let i={animation:!0,autohide:!1};this.bsToast=new Ie(e,i),t.autohide&&(this._addProgressBar(),this._setupInteractionPause())}show(){this.bsToast.show()}hide(){this.hideTimeoutId!==null&&(clearTimeout(this.hideTimeoutId),this.hideTimeoutId=null),this.bsToast.hide()}_addProgressBar(){this.progressBar=document.createElement("div"),this.progressBar.className="bslib-toast-progress-bar",this.progressBar.style.cssText=`
  ...
  </svg>`,document.body.appendChild(s.children[0])}document.readyState==="complete"?Me():document.addEventListener("DOMContentLoaded",Me)});$e();})();
