...
`+n.value.substring(t),n.selectionStart=n.selectionEnd=e+1,n.dispatchEvent(new Event("input",{bubbles:!0}))}var T,M,pe,Z,fe=v(()=>{"use strict";y();T="textSubmitInputBinding",M={input:"bslib-input-submit-textarea",container:"bslib-submit-textarea-container",button:"bslib-submit-textarea-btn",submitKey:"bslib-submit-key"},pe=new IntersectionObserver(n=>{n.forEach(e=>{e.isIntersecting&&J(e.target)})}),Z=class extends f{find(e){return $(e).find(`.${M.input} textarea`)}initialize(e){me(e),J(e),Le(e)}getValue(e){return $(e).data("val")}setValue(e,t){e.value=t}subscribe(e,t){function i(){$(e).data("val",e.value),e.value="",e.dispatchEvent(new Event("input",{bubbles:!0})),t("event")}let s=D(e);s.classList.contains("shiny-bound-input")?$(s).on(`shiny:inputchanged.${T}`,i):$(s).on(`click.${T}`,i),$(e).on(`input.${T}`,function(){me(e),J(e)}),$(e).on(`keydown.${T}`,function(o){if(o.key!=="Enter")return;if(!e.value){o.preventDefault();return}if(o.shiftKey)return;if(o.altKey){o.preventDefault(),Se(e);return}let d=e.hasAttribute("data-needs-modifier");if(!d){o.preventDefault(),s.click();return}let a=o.ctrlKey||o.metaKey;if(d&&a){o.preventDefault(),s.click();return}});let r=e.closest(`.${M.container}`);$(r).on(`click.${T}`,o=>{o.target.classList.contains(M.container)&&e.focus()}),pe.observe(e)}unsubscribe(e){$(e).off(`.${T}`);let t=e.nextElementSibling;$(t).off(`.${T}`);let i=e.closest(`.${M.container}`);$(i).off(`.${T}`),pe.unobserve(e)}receiveMessage(e,t){return u(this,null,function*(){let i=e.value;if(t.value!==void 0&&(e.value=t.value,e.dispatchEvent(new Event("input",{bubbles:!0}))),t.placeholder!==void 0&&(e.placeholder=t.placeholder),t.label!==void 0){let s=$(e).closest(`.${M.input}`).find("label");yield re(t.label,s)}t.submit&&(D(e).click(),e.value=i),t.focus&&e.focus()})}};E(Z,"submit-text-area")});function W(n){if(window.Shiny)for(let[e,t]of Object.entries(n))window.Shiny.addCustomMessageHandler(e,t)}var Q=v(()=>{"use strict"});function we(n){return u(this,null,function*(){var N,te;let{html:e,deps:t,autohide:i,duration:s,position:r,id:o}=n;if(!window.bootstrap||!window.bootstrap.Toast){P({headline:"Bootstrap 5 Required",message:"Toast notifications require Bootstrap 5.",status:"error"});return}let d=document.getElementById(o);if(d){let w=k.get(d);w&&(w.hide(),k.delete(d)),(te=(N=window==null?void 0:window.Shiny)==null?void 0:N.unbindAll)==null||te.call(N,d),d.remove()}let a=Me.getOrCreateToaster(r);yield p(a,{html:e,deps:t},"beforeEnd");let h=document.getElementById(o);if(!h){P({headline:"Toast Creation Failed",message:`Failed to create toast with id "${o}".`,status:"error"});return}let _=new ee(h,{autohide:i,duration:s});k.set(h,_),_.show(),h.addEventListener("hidden.bs.toast",()=>{var w,ie;(ie=(w=window==null?void 0:window.Shiny)==null?void 0:w.unbindAll)==null||ie.call(w,h),h.remove(),k.delete(h),a.children.length===0&&a.remove()})})}function He(n){let{id:e}=n,t=document.getElementById(e);if(!t){P({headline:"Toast Not Found",message:`No toast with id "${e}" was found.`,status:"warning"});return}let i=k.get(t);i&&i.hide()}var Te,x,Me,ee,k,ve=v(()=>{"use strict";Q();y();Te=window.bootstrap?window.bootstrap.Toast:class{},x=class{constructor(){this.containers=new Map}getOrCreateToaster(e){let t=this.containers.get(e);return(!t||!document.body.contains(t))&&(t=x._createToaster(e),document.body.appendChild(t),this.containers.set(e,t)),t}static _createToaster(e){let t=document.createElement("div");return t.className="toast-container position-fixed p-1 p-md-2",t.setAttribute("data-bslib-toast-container",e),t.classList.add(...x._positionClasses(e)),t}static _positionClasses(e){return{"top-left":["top-0","start-0"],"top-center":["top-0","start-50","translate-middle-x"],"top-right":["top-0","end-0"],"middle-left":["top-50","start-0","translate-middle-y"],"middle-center":["top-50","start-50","translate-middle"],"middle-right":["top-50","end-0","translate-middle-y"],"bottom-left":["bottom-0","start-0"],"bottom-center":["bottom-0","start-50","translate-middle-x"],"bottom-right":["bottom-0","end-0"]}[e]}},Me=new x,ee=class{constructor(e,t){this.progressBar=null;this.timeStart=0;this.timeRemaining=0;this.hideTimeoutId=null;this.isPaused=!1;this.isPointerOver=!1;this.hasFocus=!1;this.element=e,this.timeRemaining=t.duration||5e3;let i={animation:!0,autohide:!1};this.bsToast=new Te(e,i),t.autohide&&(this._addProgressBar(),this._setupInteractionPause())}show(){this.bsToast.show()}hide(){this.hideTimeoutId!==null&&(clearTimeout(this.hideTimeoutId),this.hideTimeoutId=null),this.bsToast.hide()}_addProgressBar(){this.progressBar=document.createElement("div"),this.progressBar.className="bslib-toast-progress-bar",this.progressBar.style.cssText=`
  ...
  </svg>`,document.body.appendChild(n.children[0])}document.readyState==="complete"?ge():document.addEventListener("DOMContentLoaded",ge)});Ce();})();
