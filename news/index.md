...
- Added toast notifications based on [Bootstrap’s Toast
  ...
  [`toast()`](https://rstudio.github.io/bslib/reference/toast.md) to
...
- [`sidebar_toggle()`](https://rstudio.github.io/bslib/reference/deprecated.md)
...
[`sidebar()`](https://rstudio.github.io/bslib/reference/sidebar.md). In
addition, the new
...
- For
  ...
  - The page-level `sidebar` for
    [`page_sidebar()`](https://rstudio.github.io/bslib/reference/page_sidebar.md)/[`page_navbar()`](https://rstudio.github.io/bslib/reference/page_navbar.md)
...
- For
  ...
  - When `row_heights` is a
    non-[`breakpoints()`](https://rstudio.github.io/bslib/reference/breakpoints.md)
...
- [`card()`](https://rstudio.github.io/bslib/reference/card.md)s (and
  [`value_box()`](https://rstudio.github.io/bslib/reference/value_box.md)s)
...
- [`page()`](https://rstudio.github.io/bslib/reference/page.md) now
  returns a `<body>` tag instead of
  [`tagList()`](https://rstudio.github.io/htmltools/reference/tagList.html).
  This change allows
  [`page()`](https://rstudio.github.io/bslib/reference/page.md) to treat
  named arguments as HTML attributes for the `<body>` tag, making it
  possible to add page-level classes or other attributes.
...
- Improved the style and appearance of the button to enter full screen
  in [`card()`](https://rstudio.github.io/bslib/reference/card.md)s and
  [`value_box()`](https://rstudio.github.io/bslib/reference/value_box.md)es
...
- [`htmltools::save_html()`](https://rstudio.github.io/htmltools/reference/save_html.html)
  ...
  [`card()`](https://rstudio.github.io/bslib/reference/card.md), etc)
  and pages with a non-default theme.
...
- [`card_body()`](https://rstudio.github.io/bslib/reference/card_body.md)
  ...
  [`card_body_fill()`](https://rstudio.github.io/bslib/reference/deprecated.md)
...
- [`page_fill()`](https://rstudio.github.io/bslib/reference/deprecated.md)
  (now called
  [`page_fillable()`](https://rstudio.github.io/bslib/reference/page_fillable.md))
...
- [`layout_column_wrap()`](https://rstudio.github.io/bslib/reference/layout_column_wrap.md)’s
...
- Adds a new
  [`accordion()`](https://rstudio.github.io/bslib/reference/accordion.md)
  API. See
  [`help(accordion)`](https://rstudio.github.io/bslib/reference/accordion.md)
...
- [`page_navbar()`](https://rstudio.github.io/bslib/reference/page_navbar.md),
  ...
  [`sidebar()`](https://rstudio.github.io/bslib/reference/sidebar.md) on
  every page/tab/pill.
  ([\#479](https://github.com/rstudio/bslib/issues/479))
- [`page_navbar()`](https://rstudio.github.io/bslib/reference/page_navbar.md)
...
- [`page_fillable()`](https://rstudio.github.io/bslib/reference/page_fillable.md)
  ...
  like [`card()`](https://rstudio.github.io/bslib/reference/card.md),
  [`layout_column_wrap()`](https://rstudio.github.io/bslib/reference/layout_column_wrap.md),
  and
  [`layout_sidebar()`](https://rstudio.github.io/bslib/reference/sidebar.md)
...
- [`page_fill()`](https://rstudio.github.io/bslib/reference/deprecated.md)
  ...
  [`page_fillable()`](https://rstudio.github.io/bslib/reference/page_fillable.md).
  ([\#498](https://github.com/rstudio/bslib/issues/498))
- [`nav()`](https://rstudio.github.io/bslib/reference/deprecated.md) has
  been deprecated in favor of
  [`nav_panel()`](https://rstudio.github.io/bslib/reference/nav-items.md)
  and
  [`nav_content()`](https://rstudio.github.io/bslib/reference/deprecated.md)
  in favor of
  [`nav_panel_hidden()`](https://rstudio.github.io/bslib/reference/nav-items.md).
...
- The `navs_*()` family of functions have been deprecated in favor of
  ...
  - [`navs_tab()`](https://rstudio.github.io/bslib/reference/deprecated.md)
    is now
    [`navset_tab()`](https://rstudio.github.io/bslib/reference/navset.md)
  - [`navs_pill()`](https://rstudio.github.io/bslib/reference/deprecated.md)
    is now
    [`navset_pill()`](https://rstudio.github.io/bslib/reference/navset.md)
  - [`navs_pill_list()`](https://rstudio.github.io/bslib/reference/deprecated.md)
    is now
    [`navset_pill_list()`](https://rstudio.github.io/bslib/reference/navset.md)
  - [`navs_bar()`](https://rstudio.github.io/bslib/reference/deprecated.md)
    is now
    [`navset_bar()`](https://rstudio.github.io/bslib/reference/navset.md)
  - [`navs_tab_card()`](https://rstudio.github.io/bslib/reference/deprecated.md)
    and
    [`navs_pill_card()`](https://rstudio.github.io/bslib/reference/deprecated.md)
    are now
    [`navset_card_tab()`](https://rstudio.github.io/bslib/reference/navset.md)
    and
    [`navset_card_pill()`](https://rstudio.github.io/bslib/reference/navset.md),
...
- Adds a new
  [`card()`](https://rstudio.github.io/bslib/reference/card.md) API as
  well as
  [`value_box()`](https://rstudio.github.io/bslib/reference/value_box.md)
  and
  [`layout_column_wrap()`](https://rstudio.github.io/bslib/reference/layout_column_wrap.md).
...
- Closed [\#377](https://github.com/rstudio/bslib/issues/377): make sure
  ...
  [`bslib::navs_hidden()`](https://rstudio.github.io/bslib/reference/deprecated.md))
...
- Added new
  [`bs_add_functions()`](https://rstudio.github.io/bslib/reference/bs_bundle.md)/[`bs_add_mixins()`](https://rstudio.github.io/bslib/reference/bs_bundle.md)
  and deprecated
  [`bs_add_declarations()`](https://rstudio.github.io/bslib/reference/deprecated.md)
  to reflect
