...
- More generally, customize most of Bootstrap's styling via Sass variables (e.g., [`font-size-base`](https://rstudio.github.io/bslib/articles/bs4-variables.html#font-size-base)).
...
> Note: this usage currently requires the development version of Shiny `remotes::install_github("rstudio/shiny")`.
