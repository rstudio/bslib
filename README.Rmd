...
(2) Once a (global) theme is initialized, you may start adding theming customizations (learn more about customizations in the [recipes](https://rstudio.github.io/bootstraplib/articles/recipes.html) and [foundations](https://rstudio.github.io/bootstraplib/articles/foundations.html) articles):

```r
bs_theme_base_colors(bg = "salmon", fg = "white")
```

(3) Add `bootstrap()` to your user interface (this step likely won't be needed in a future version of **shiny**). 
