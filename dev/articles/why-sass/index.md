...
[Bootstrap Sass](https://rstudio.github.io/bslib/dev/articles/why-sass/)
is just one example of a Sass-based project that exposes Sass variables
to allow users to easily customize CSS styles.

TODO: do a better job here

When a
[`bs_theme()`](https://rstudio.github.io/bslib/dev/reference/bs_theme.md)
is used with Shiny or R Markdown, the
