...
A [`card()`](https://rstudio.github.io/bslib/dev/reference/card.md) is
...
[`card()`](https://rstudio.github.io/bslib/dev/reference/card.md) also
has some useful named arguments (e.g., `full_screen`, `height`, etc).

At their core,
[`card()`](https://rstudio.github.io/bslib/dev/reference/card.md) and
card items are just an HTML
...
[`card()`](https://rstudio.github.io/bslib/dev/reference/card.md) that
aren’t “known”
...
By default, a
[`card()`](https://rstudio.github.io/bslib/dev/reference/card.md)’s size
...
A [`card()`](https://rstudio.github.io/bslib/dev/reference/card.md)’s
default behavior is optimized for facilitating [filling
layouts](https://rstudio.github.io/bslib/dev/articles/filling). More
...
specified height. This means, by specifying `height = 250` we’ve
effectively shrunk the plot’s height from its default of 400 down to
about 200 pixels. And, when expanded to `full_screen`, the plot grows to
match the
[`card()`](https://rstudio.github.io/bslib/dev/reference/card.md)’s new
size.
...
[`card_body()`](https://rstudio.github.io/bslib/dev/reference/card_body.md)’s
...
[filling layouts](https://rstudio.github.io/bslib/dev/articles/filling)
(i.e.,
...
layouts](https://rstudio.github.io/bslib/dev/articles/filling), a **fill
...
[`card()`](https://rstudio.github.io/bslib/dev/reference/card.md)s as
well some other options like `title` (since there is no natural place
for a
[`card_header()`](https://rstudio.github.io/bslib/dev/reference/card_body.md)
...
[`card()`](https://rstudio.github.io/bslib/dev/reference/card.md). That
is, if the direct children aren’t already card items (e.g.,
...
layouts](https://rstudio.github.io/bslib/dev/articles/sidebars),
[`layout_sidebar()`](https://rstudio.github.io/bslib/dev/reference/sidebar.md)
just works when placed inside in a
[`card()`](https://rstudio.github.io/bslib/dev/reference/card.md). In
this case, if you want **fill item**s (e.g., `plotly_widget`) to still
fill the card like we’ve [seen before](#filling-outputs), you’ll need to
set `fillable = TRUE` in
[`layout_sidebar()`](https://rstudio.github.io/bslib/dev/reference/sidebar.md).
...
[`card_image()`](https://rstudio.github.io/bslib/dev/reference/card_body.md)s,
...
boxes](https://rstudio.github.io/bslib/dev/articles/value-boxes) article
