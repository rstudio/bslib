...
started
article](https://rstudio.github.io/bslib/dev/articles/any-project),
...
article](https://rstudio.github.io/bslib/dev/articles/sidebars), you’ll
...
pages](https://rstudio.github.io/bslib/dev/articles/sidebars/index.html#conditional-contents),
(2) [put a particular `sidebar()` with a given
page](https://rstudio.github.io/bslib/dev/articles/sidebars/index.html#multi-page-example),
and even (3) [put sidebar layouts inside of a
`card()`](https://rstudio.github.io/bslib/dev/articles/sidebars/index.html#multi-page-example).
...
layout](https://rstudio.github.io/bslib/dev/articles/filling), meaning
that outputs like
[`plotOutput()`](https://rdrr.io/pkg/shiny/man/plotOutput.html),
...
[`card()`](https://rstudio.github.io/bslib/dev/reference/card.md)s that
...
[`card()`](https://rstudio.github.io/bslib/dev/reference/card.md)s to
...
be opened via
[`sidebar()`](https://rstudio.github.io/bslib/dev/reference/sidebar.md)’s
`open` argument.
...
boxes](https://rstudio.github.io/bslib/dev/articles/value-boxes)
...
making it easy to add headers, footers, `full_screen` behavior, etc.

To learn more, visit the
[cards](https://rstudio.github.io/bslib/dev/articles/cards) and
[sidebars](https://rstudio.github.io/bslib/dev/articles/sidebars)
articles.
...
article](https://rstudio.github.io/bslib/dev/articles/theming), you’ll
learn some general theming strategies that also translate to dashboards.
That is, by passing a
...
variables](https://rstudio.github.io/bslib/dev/articles/bs5-variables),
and much more. Keep in mind, however, that
[`bs_theme()`](https://rstudio.github.io/bslib/dev/reference/bs_theme.md)
