...
Below is a search-able table of Bootstrap 5 Sass variables. If you
aren’t sure what a Sass variable is or how to use them, see this [Get
Started article](https://rstudio.github.io/bslib/dev/articles/theming).
A few things to keep in mind when using this table:
