...
inside [cards](https://rstudio.github.io/bslib/dev/articles/cards), fill
inside [sidebar
layouts](https://rstudio.github.io/bslib/dev/articles/sidebars), or
...
[`card()`](https://rstudio.github.io/bslib/dev/reference/card.md)s have
a `min_height` argument (to prevent fill items from shrinking too much).
...
[cards](https://rstudio.github.io/bslib/dev/articles/cards). In most
cases, a card has numerous children like a header and a body, and the
body commonly contains fill item(s) (to ensure fill items). This is why
...
inline
elements](https://rstudio.github.io/bslib/dev/articles/cards#flexbox).
So, that’s why, it’s recommended that you use [multiple card
bodies](https://rstudio.github.io/bslib/dev/articles/cards#multiple-card_body)
...
[`layout_columns()`](https://rstudio.github.io/bslib/dev/reference/layout_columns.md),
see [this
article](https://rstudio.github.io/bslib/dev/articles/column-layout).
...
[`card()`](https://rstudio.github.io/bslib/dev/reference/card.md) is
then a fillable container with a specified height, the
[`card_body()`](https://rstudio.github.io/bslib/dev/reference/card_body.md)
...
[`layout_sidebar()`](https://rstudio.github.io/bslib/dev/reference/sidebar.md),
see [this
article](https://rstudio.github.io/bslib/dev/articles/sidebars).
