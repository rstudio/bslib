...
[`card()`](https://rstudio.github.io/bslib/dev/reference/card.md). For a
...
- `as.card_item()`: Mark an object as a card item. This will prevent the
  [`card()`](https://rstudio.github.io/bslib/dev/reference/card.md) from
...
[`card()`](https://rstudio.github.io/bslib/dev/reference/card.md) or
`card_body()`.
