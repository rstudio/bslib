...
The quickest way to see what [bslib](https://rstudio.github.io/bslib/)
can do is to run
[`bslib::bs_theme_preview()`](https://rstudio.github.io/bslib/dev/reference/bs_theme_preview.md)
at the console. This launches a demo app containing both
[bslib](https://rstudio.github.io/bslib/) and
[shiny](https://shiny.posit.co/) UI components as well as an theming
widget
([`bslib::bs_themer()`](https://rstudio.github.io/bslib/dev/reference/run_with_themer.md))
overlaid on the app. See [real-time
...
real-time.](articles/theming/themer.gif)

## Get started

Since [bslib](https://rstudio.github.io/bslib/) covers a wide array of
uses, it has numerous getting started articles, each focusing on a
particular interest:
...
- The [RStudio community](https://forum.posit.co/) is a friendly place
