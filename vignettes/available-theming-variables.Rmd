...
htmltools::tagList(rmarkdown::html_dependency_font_awesome(), rmarkdown::html_dependency_bootstrap("default"))
```
      ...
      drawCallback = DT::JS(glue("
        function( settings ) {
          ...
          this.find('tbody td:nth-child(1)').on('click', function(){
            // Don't update pagination because we are for sure on the right page alreadt
