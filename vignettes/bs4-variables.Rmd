...
The table below provides a convenient interface for discovering and learning about Bootstrap 4 Sass variables. For more information and examples on why and how to actually use these variables inside of `bs_theme()`, see the [Sass variables section](theming.html#sass-variables) of the Custom Theming article.
