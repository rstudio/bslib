...
When `sidebar` is an argument to a function containing multiple pages or panels, it creates a **[shared sidebar](#shared-sidebar)**.
...
It also fits nicely into [card components](#cards) and [nav pages or tabs](#navbar-pages) allowing you to add a sidebar to individual pages or tabs.
:::
