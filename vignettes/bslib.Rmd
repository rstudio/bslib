...
* [Bootstrap 5](https://getbootstrap.com/docs/4.6/getting-started/theming/) `bs_theme(version = 5)`: intended for new projects. 
* [Bootstrap 4](https://getbootstrap.com/docs/4.6/getting-started/theming/) `bs_theme(version = 4)`: intended for "newer" projects that we're created before Bootstrap 5 support was added. 
