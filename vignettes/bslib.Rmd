...
* [Bootstrap 4](https://getbootstrap.com/docs/4.6/) `bs_theme(version = 4)`: intended for "newer" projects that we're created before Bootstrap 5 support was added. 
...
`bslib` doesn't require that you actually specify a Bootstrap version. In that case, it provides the currently recommended version of Bootstrap for new projects. Currently Bootstrap 5 is recommended, but that may change to Bootstrap 6+ in the near future, so it's best practice to specify the version, especially if reproducibility is important and your project does any of the following:
...
With [Bootstrap 4 (or higher)](#versions), you can use utility classes to easily add or subtract styles on specific elements to handle common UI problems like spacing, border, colors, and more. [See here](utility-classes.html) for some useful examples specific to Shiny and R Markdown as well as [here for the full list](https://getbootstrap.com/docs/4.6/utilities/borders/) of Bootstrap 4 Utility Classes.
