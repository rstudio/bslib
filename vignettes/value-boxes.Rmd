...
To layout multiple value boxes, it's recommended to use `layout_column_wrap()`, which ensures a uniform height and width (at least by default) across the boxes.
