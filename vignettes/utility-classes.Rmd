...
[Bootstrap 4 (and higher)](bslib.html#versions) comes with a suite of handy utility classes for handling common yet fickle styling issues like [spacing](https://getbootstrap.com/docs/4.6/utilities/spacing/), [borders](https://getbootstrap.com/docs/4.6/utilities/borders/), [sizing](https://getbootstrap.com/docs/4.6/utilities/sizing/), [layout](https://getbootstrap.com/docs/4.6/utilities/flex/), [colors](https://getbootstrap.com/docs/4.6/utilities/colors/), and more.
