...
::: row
::: col-md-6
Use the `card_body_stretch()` function to wrap an output container (e.g.  `shiny::plotOutput()`, `DT::dataTableOutput()`) when inside of a card. `card_body_stretch` has two main benefits:
...
2.  If the card is taller than the natural height of its contents, `card_body_stretch()` stretches to take the extra room. The example's animation demonstrates this.
:::
...
plot_card <- card(class = "w-50",
  ...
  card_body_stretch(plotOutput("plot1"), height = 200),
  "The above is a plot",
