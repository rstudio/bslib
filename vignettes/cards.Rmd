...
::: row
::: col-md-6
Keep in mind that, by default, `card_body()` adds padding around it's content while `card_body_fill()` doesn't. In either case, you can override those defaults with the [spacing utility classes](https://getbootstrap.com/docs/5.2/utilities/spacing/).
:::
...
::: row
::: col-md-6
Moreover, if the contents of a `card_body_fill()` aren't full width, you can horizontally center them via [flex utility classes](https://getbootstrap.com/docs/5.2/utilities/flex/).
:::
