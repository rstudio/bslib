...
One major feature that bslib adds to Bootstrap cards is the ability to expand the card to a [full screen view](#responsive-sizing). Often this feature wants [output that resizes itself to fit its card container](#responsive-sizing). To do this today in the same way presented in this article, you'll need the development version of numerous packages. Grab all them by installing the development version of bslib this way:
