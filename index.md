...
can do is to run
[`bslib::bs_theme_preview()`](https://rstudio.github.io/bslib/reference/bs_theme_preview.md)
...
widget
([`bslib::bs_themer()`](https://rstudio.github.io/bslib/reference/run_with_themer.md))
