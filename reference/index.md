...
- [`page()`](https://rstudio.github.io/bslib/reference/page.md)
  [`page_fluid()`](https://rstudio.github.io/bslib/reference/page.md)
...
- [`navset_tab()`](https://rstudio.github.io/bslib/reference/navset.md)
  ...
  [`navset_underline()`](https://rstudio.github.io/bslib/reference/navset.md)
...
- [`card()`](https://rstudio.github.io/bslib/reference/card.md) : A
...
- [`card_body()`](https://rstudio.github.io/bslib/reference/card_body.md)
  ...
  [`card_footer()`](https://rstudio.github.io/bslib/reference/card_body.md)
  [`card_image()`](https://rstudio.github.io/bslib/reference/card_body.md)
  [`as.card_item()`](https://rstudio.github.io/bslib/reference/card_body.md)
  [`is.card_item()`](https://rstudio.github.io/bslib/reference/card_body.md)
  : Card items

### Toolbars

Toolbars are compact containers for buttons, inputs, and other UI
elements. They are particularly useful in card headers and footers, or
anywhere you need a clean, horizontal layout of controls.

- [`toolbar()`](https://rstudio.github.io/bslib/reference/toolbar.md) :
  Toolbar component
- [`toolbar_input_button()`](https://rstudio.github.io/bslib/reference/toolbar_input_button.md)
  [`update_toolbar_input_button()`](https://rstudio.github.io/bslib/reference/toolbar_input_button.md)
  : Add a toolbar input button
- [`toolbar_input_select()`](https://rstudio.github.io/bslib/reference/toolbar_input_select.md)
  [`update_toolbar_input_select()`](https://rstudio.github.io/bslib/reference/toolbar_input_select.md)
  : Toolbar Input Select
- [`toolbar_divider()`](https://rstudio.github.io/bslib/reference/toolbar_divider.md)
  [`toolbar_spacer()`](https://rstudio.github.io/bslib/reference/toolbar_divider.md)
...
defined with
[`accordion_panel()`](https://rstudio.github.io/bslib/reference/accordion.md)
...
- [`accordion_panel_set()`](https://rstudio.github.io/bslib/reference/accordion_panel_set.md)
  [`accordion_panel_open()`](https://rstudio.github.io/bslib/reference/accordion_panel_set.md)
  [`accordion_panel_close()`](https://rstudio.github.io/bslib/reference/accordion_panel_set.md)
  [`accordion_panel_insert()`](https://rstudio.github.io/bslib/reference/accordion_panel_set.md)
  [`accordion_panel_remove()`](https://rstudio.github.io/bslib/reference/accordion_panel_set.md)
  [`accordion_panel_update()`](https://rstudio.github.io/bslib/reference/accordion_panel_set.md)
...
- [`tooltip()`](https://rstudio.github.io/bslib/reference/tooltip.md)
  [`toggle_tooltip()`](https://rstudio.github.io/bslib/reference/tooltip.md)
  [`update_tooltip()`](https://rstudio.github.io/bslib/reference/tooltip.md)
  : Add a tooltip to a UI element
- [`popover()`](https://rstudio.github.io/bslib/reference/popover.md)
  [`toggle_popover()`](https://rstudio.github.io/bslib/reference/popover.md)
  [`update_popover()`](https://rstudio.github.io/bslib/reference/popover.md)
  : Add a popover to a UI element
- [`toast()`](https://rstudio.github.io/bslib/reference/toast.md)
  [`toast_header()`](https://rstudio.github.io/bslib/reference/toast.md)
  : Toast notifications
...
- [`input_code_editor()`](https://rstudio.github.io/bslib/reference/input_code_editor.md)
  [`update_code_editor()`](https://rstudio.github.io/bslib/reference/input_code_editor.md)
  : Code editor input

- [`input_dark_mode()`](https://rstudio.github.io/bslib/reference/input_dark_mode.md)
  [`toggle_dark_mode()`](https://rstudio.github.io/bslib/reference/input_dark_mode.md)
  : Dark mode input control

- [`input_submit_textarea()`](https://rstudio.github.io/bslib/reference/input_submit_textarea.md)
  [`update_submit_textarea()`](https://rstudio.github.io/bslib/reference/input_submit_textarea.md)
...
- [`input_switch()`](https://rstudio.github.io/bslib/reference/input_switch.md)
  [`update_switch()`](https://rstudio.github.io/bslib/reference/input_switch.md)
  [`toggle_switch()`](https://rstudio.github.io/bslib/reference/input_switch.md)
...
- [`bs_theme()`](https://rstudio.github.io/bslib/reference/bs_theme.md)
  ...
  [`is_bs_theme()`](https://rstudio.github.io/bslib/reference/bs_theme.md)
  : Create a Bootstrap theme
- [`bs_add_variables()`](https://rstudio.github.io/bslib/reference/bs_bundle.md)
  ...
  [`bs_add_functions()`](https://rstudio.github.io/bslib/reference/bs_bundle.md)
  [`bs_add_mixins()`](https://rstudio.github.io/bslib/reference/bs_bundle.md)
  [`bs_bundle()`](https://rstudio.github.io/bslib/reference/bs_bundle.md)
...
- [`font_face`](https://rstudio.github.io/bslib/reference/font_face.md)
  ...
  [`font_collection`](https://rstudio.github.io/bslib/reference/font_face.md)
...
- [`bs_global_theme()`](https://rstudio.github.io/bslib/reference/bs_global_theme.md)
  [`bs_global_set()`](https://rstudio.github.io/bslib/reference/bs_global_theme.md)
  [`bs_global_get()`](https://rstudio.github.io/bslib/reference/bs_global_theme.md)
  [`bs_global_clear()`](https://rstudio.github.io/bslib/reference/bs_global_theme.md)
  [`bs_global_add_variables()`](https://rstudio.github.io/bslib/reference/bs_global_theme.md)
  [`bs_global_add_rules()`](https://rstudio.github.io/bslib/reference/bs_global_theme.md)
  [`bs_global_bundle()`](https://rstudio.github.io/bslib/reference/bs_global_theme.md)
  [`bs_global_theme_update()`](https://rstudio.github.io/bslib/reference/bs_global_theme.md)
  : Global theming
...
- [`bs_remove()`](https://rstudio.github.io/bslib/reference/bs_remove.md)
  [`bs_retrieve()`](https://rstudio.github.io/bslib/reference/bs_remove.md)
...
- [`as_fill_carrier()`](https://rstudio.github.io/bslib/reference/as_fill_carrier.md)
  [`as_fillable_container()`](https://rstudio.github.io/bslib/reference/as_fill_carrier.md)
  [`as_fill_item()`](https://rstudio.github.io/bslib/reference/as_fill_carrier.md)
  [`remove_all_fill()`](https://rstudio.github.io/bslib/reference/as_fill_carrier.md)
  [`is_fill_carrier()`](https://rstudio.github.io/bslib/reference/as_fill_carrier.md)
  [`is_fillable_container()`](https://rstudio.github.io/bslib/reference/as_fill_carrier.md)
  [`is_fill_item()`](https://rstudio.github.io/bslib/reference/as_fill_carrier.md)
  : Test and/or coerce fill behavior

### Theming utility functions

- [`bs_get_variables()`](https://rstudio.github.io/bslib/reference/bs_get_variables.md)
  [`bs_get_contrast()`](https://rstudio.github.io/bslib/reference/bs_get_variables.md)
